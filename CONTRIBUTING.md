Contributing to ariacoin Core
============================

The ariacoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ariacoin Core project, and is not to be
confused with overall ariacoin Network Protocol consensus changes.

Whether a pull request is merged into ariacoin Core rests with the project merge
...
Patches that change ariacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ariacoin consensus, it must have been
...
The project leader is the release manager for each ariacoin Core release.
