...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ariacoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ariacoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ariacoin features */
        {"ariacoin", "masternode", &masternode, true, true, false},
        {"ariacoin", "masternodelist", &masternodelist, true, true, false},
        {"ariacoin", "mnbudget", &mnbudget, true, true, false},
        {"ariacoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ariacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ariacoin", "mnsync", &mnsync, true, true, false},
        {"ariacoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"ariacoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ariacoind, or the -server option to ariacoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ariacoin-cli " + methodname + " " + args + "\n";
}
