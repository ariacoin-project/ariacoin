...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ariacoin Core ariacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ariacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ariacoin transaction") + "\n" +
                               "  ariacoin-tx [options] -create [commands]   " + _("Create hex-encoded ariacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ariacoin transaction
