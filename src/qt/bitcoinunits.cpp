...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case PIE:
            return QString("tRIA");
        case mPIE:
            return QString("mtRIA");
        case uPIE:
            return QString::fromUtf8("μtRIA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case PIE:
            return QString("RIA");
        case mPIE:
            return QString("Milli-RIA (1 / 1" THIN_SP_UTF8 "000)");
        case uPIE:
            return QString("Micro-RIA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case PIE:
            return QString("TestRIA");
        case mPIE:
            return QString("Milli-TestRIA (1 / 1" THIN_SP_UTF8 "000)");
        case uPIE:
            return QString("Micro-TestRIA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
