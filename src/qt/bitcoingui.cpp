                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Aria Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ariacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ariacoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ariacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ariacoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ariacoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ariacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ariacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ariacoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ariacoin Core help message to get a list with possible ariacoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ariacoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ariacoin network", "", count));
}
...
{
    QString strTitle = tr("ariacoin Core"); // default title
