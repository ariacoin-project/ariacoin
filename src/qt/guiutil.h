...
/** Utility functions used by the ariacoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ariacoin addresses in monospace font
...
// Parse "ariacoin:" URI into recipient object, return true on successful parsing
