...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ariacoin Core"),
     ...
     * override -datadir in the ariacoin.conf file in the default data directory
     * (to be consistent with ariacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
