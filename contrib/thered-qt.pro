...
RESOURCES += src/qt/ariacoin.qrc src/qt/ariacoin_locale.qrc

TRANSLATIONS += src/qt/locale/ariacoin_bg.ts \
                src/qt/locale/ariacoin_de.ts \
                src/qt/locale/ariacoin_en.ts \
                src/qt/locale/ariacoin_es.ts \
                src/qt/locale/ariacoin_fi.ts \
                src/qt/locale/ariacoin_fr.ts \
                src/qt/locale/ariacoin_it.ts \
                src/qt/locale/ariacoin_ja.ts \
                src/qt/locale/ariacoin_pl.ts \
                src/qt/locale/ariacoin_pt.ts \
                src/qt/locale/ariacoin_ru.ts \
                src/qt/locale/ariacoin_sk.ts \
                src/qt/locale/ariacoin_sv.ts \
                src/qt/locale/ariacoin_vi.ts \
                src/qt/locale/ariacoin_zh_CN.ts \
                src/qt/locale/ariacoin_zh_TW.ts
