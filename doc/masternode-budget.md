...
ariacoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ariacoin_address\> \<monthly_payment_ariacoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ ariacoin, _12_ times over the course of a year totaling _24000_ ariacoin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ariacoin_address\> \<monthly_payment_ariacoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` ariacoin.
 ...
 * vote-many          - Vote on a ariacoin initiative
 * vote-alias         - Vote on a ariacoin initiative
 * vote               - Vote on a ariacoin initiative/budget
