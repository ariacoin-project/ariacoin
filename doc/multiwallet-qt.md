...
In order to support loading of multiple wallets in ariacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ariacoin.cpp.
...
Changes to ariacoin.cpp
----------------------
ariacoin.cpp is the entry point into ariacoin-qt, and as such, will require some minor modifications to provide hooks for
