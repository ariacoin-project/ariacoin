...
This mechanism has been integrated into Bitcore-Node-ariacoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ariacoin-Project/insight-api-ariacoin#web-socket-api](https://github.com/ariacoin-Project/insight-api-ariacoin#web-socket-api) 
* API: [https://github.com/ariacoin-Project/insight-api-ariacoin#swifttx-transactions](https://github.com/ariacoin-Project/insight-api-ariacoin#swifttx-transactions) 
...
By default, the ariacoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ariacoin Core daemon:
